...
import ReadingStats from '@/components/habits/ReadingStats';
// Removed ReadingList and ReadingFilter as we are simplifying to Timeline only
  ...
  return (
    <main className="max-w-7xl mx-auto p-8 bg-gray-50 min-h-screen">
      ...
      <header className="mb-8">
        <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight text-left">Reading Journey</h1>
        <p className="text-gray-500 text-left">Your historical reading activity log.</p>
      </header>
      ...
      {/* Content Section - Simplified to only show Timeline aligned left */}
      <section className="mt-12 flex justify-start">
        {loading ? (
          <div className="text-left py-12">
            <p className="text-gray-500 italic">Loading activity feed...</p>
          </div>
        ) : (
